	...
	jQuery(function($){
		...
		$.ajax({
			...
			success(data) {
				...
				// $("[text=startDate]").text(data.startDate);
				// $("[text=endDate]").text(data.endDate);
				// //...
				$("[text]").each(function () {
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>市场活动-<span text="name"></span> <small>
				<span text="startDate"></span> ~ <span text="endDate"></span></small>
			</h3>
		</div>
