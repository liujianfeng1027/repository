    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            function load(currentPage,rowsPerPage) {
                $.ajax({
                    ...
                    data: {
                        ...
                        rowsPerPage, // 相当于 rowsPerPage: rowsPerPage,
                        // 如果search是一个pojo，则参数名格式为：search.name
                        "search['name']": $("#search_name").val(),
                        "search['owner']": $("#search_owner").val(),
                        "search['startDate']": $("#search_startDate").val(),
                        "search['endDate']": $("#search_endDate").val(),
                    },
                    success(page) {
                        var data = page.data;
                        ...
                        $(data).each(function () {
                            ...
                            html += '    <td><a href="detail.html?id='+this.id+'" style="text-decoration: none; cursor: pointer;">'+this.name+'</a></td>';
            ...
            $("#exportBtn").click(function () {
                // 文件下载，就是让浏览器的地址栏指向后端的下载程序即可，不会发生跳转现象
                // 文件下载不支持ajax
            ...
            $("#importBtn").click(function () {
                ...
                $.ajax({
                    ...
                    type: "post",
                    data: data,
                    // 以下2个属性，表示不对提交的数据进行任何处理，数据以二进制形式提交
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select owner class="form-control" id="create-marketActivityOwner">
            ...
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input date class="form-control" type="text" id="search_startDate"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">结束日期</div>
                        <input date class="form-control" type="text" id="search_endDate">
                    </div>
                </div>
